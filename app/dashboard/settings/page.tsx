...
import { RiPencilLine, RiDeleteBinLine, RiAddLine, RiUserLine } from 'react-icons/ri';
    ...
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-8">
          ...
          {/* Preferences Section */}
          <div 
            className="border-b pb-6 hidden"
            role="region"
            aria-label="Preferences section for configuring notifications and security settings"
          >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p 
                  ...
                  aria-label="Description: Receive email updates about your campaigns"
                >
              ...
              <button 
                ...
                aria-label="Configure email notification settings"
            ...
            <div className="flex items-center justify-between">
              <div>
                <label 
                  className="text-sm font-medium text-gray-700"
                  aria-label="Two-Factor Authentication Setting"
                >
                  Two-Factor Authentication
                </label>
                <p 
                  className="text-sm text-gray-500"
                  aria-label="Description: Add an extra layer of security to your account"
                >
              ...
              <button 
                className="bg-blue-600 text-white px-3 py-1 rounded-md text-sm"
                aria-label="Enable two-factor authentication for additional security"
                title="Enable 2FA"
              >
                Enable
              </button>
          ...
          >
            ...
            <div className="space-y-4">
              <button 
                ...
                aria-label="Delete Account - Warning: This action cannot be undone"
